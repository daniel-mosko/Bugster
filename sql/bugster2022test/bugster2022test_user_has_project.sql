...
--
-- Host: localhost    Database: bugster2022test
-- ------------------------------------------------------
...
CREATE TABLE `user_has_project` (
  ...
  CONSTRAINT `fk_user_has_project_project1` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`),
  CONSTRAINT `fk_user_has_project_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
-- Dump completed on 2022-11-03 14:52:55
